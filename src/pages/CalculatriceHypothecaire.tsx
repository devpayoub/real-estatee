...
const CalculatriceHypothecaire = () => {
  ...
  const calculateMortgage = () => {
    ...
    const rate = parseFloat(mortgageData.interestRate) / 100 / 12; // Monthly rate
                    ...
                    <Card className="bg-gradient-to-r from-realestate-lightblue to-realestate-lightred border-realestate-blue/20">
                      <CardContent className="p-8">
                        <div className="text-center">
                          ...
                          <h3 className="text-2xl font-bold text-realestate-blue mb-4">
                            Résultats de votre hypothèque
                          </h3>
                          
                          <div className="grid gap-6">
                            <div className="bg-white rounded-lg p-6 shadow-md">
                              <h4 className="text-lg font-semibold text-realestate-blue mb-2">
                                Paiement mensuel
                              </h4>

...
const HeroSection = () => {
  return (
    <div className="flex flex-col w-full pt-28 pb-16 px-6 md:px-12">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-gradient-to-br from-realestate-blue/5 to-realestate-red/5 p-8 rounded-xl">
        ...
        {/* Call to Action */}
        <div className="text-center bg-gradient-to-r from-realestate-blue/10 to-realestate-red/10 p-8 rounded-xl">
